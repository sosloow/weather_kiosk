...
config :weather_server, WeatherServerWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: WeatherServerWeb.ErrorHTML, json: WeatherServerWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: WeatherServer.PubSub,
  live_view: [signing_salt: "O44+JMr5"]
...
config :weather_server, WeatherServer.Mailer, adapter: Swoosh.Adapters.Local
